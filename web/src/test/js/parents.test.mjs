// The reply-parent lookup: which `e` tag (NIP-10: markers first, position
// last), whose pubkey, and that "this relay does not hold the parent" is
...
const { replyTarget, replyAuthor, replyPerson, seedParentAuthors, unknownParents, loadParentAuthors } =
  await import(new URL("../../main/resources/web/shared/parents.js", import.meta.url));
...
seedParentAuthors([null, {}, { id: "junk", pubkey: alice }]);
