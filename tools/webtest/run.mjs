...
let failed = 0;
for (const t of ["nip19.test.mjs", "query.test.mjs", "calendar.test.mjs", "cards.test.mjs", "relay.test.mjs", "profiles.test.mjs", "parents.test.mjs", "preload.test.mjs", "avatar.test.mjs"]) {
